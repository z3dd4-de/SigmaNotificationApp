# BikeDBJsonCreator (formerly SigmaNotificationApp)
A small app to check if a Sigma speedometer is available in its docking station and to read its data. Can also be used to manually create JSON files for BikeDB.
...
# Copyright
Besides the license, this application is the original work of Dipl.-Biol. Björn Zedroßer, Cologne/Erftstadt, Germany.
(c) 2025-2026